...
import ansiedadImage from './imgs/ansi.jpg'; 
  ...
  return (
    ...
    <button class="MoreText" style={{ left: `${positionX[0]}%` , top: `${positionX[2]}px`}} onClick={()=>MoreText()}>Seguir leyendo</button>
      <div class={ `${positionX[1]} ${modo}`} >
        ...
        <h6>Ambas funcionan, pero van mejor en conjunto.</h6>  
        <h4 class='subtitulo'>¿Cómo ayudo? </h4>
        <p>Algunas formas de ayudar a una persona sufriendo un ataque de ansiedad son: •Primero que nada, no alterarse, o la persona podría ponerse aún más ansiosa. •Si la persona suele tomar medicamentos cuando tiene ataques de pánico, dárselos, pero no forzarlo a tomarlos. 
